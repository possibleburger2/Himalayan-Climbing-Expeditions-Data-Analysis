...
We use a binomial logistic regression model to determine the probability of success based on a variety of demographic, environmental, and organizational factors.
...
It connects to Expeditions with `expeditions_id` and contains a lot of information about the specific member during the expedition.
...
#| fig-width: 10
#| fig-height: 5
#| fig-cap: "A slight majority of Expeditions succeed, with the most common reasons expeditions fail being environmental issues"
...
#| echo: false
#| label: fig-members
#| fig-cap: "Most expeditions have less than 3 members showing an exponential decrease with an increase in members. The red lines indicate member amounts that have only had one expedition"
...
#| fig-cap: "Relationship of male proportion of expedition and success is a small positive relationship possibly explained by other factors"
...
We see the RMSE doesn't change, meaning it retains the same accuracy as the full model and the AIC is decreased.
